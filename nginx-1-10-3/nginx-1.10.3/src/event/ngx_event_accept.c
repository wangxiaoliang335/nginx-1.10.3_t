...
ngx_event_accept(ngx_event_t *ev)
{
    ...
    do {
        ...
        ngx_log_error(NGX_LOG_ERR, ev->log, 0, " ngx_event_accept Entry accept4 ev:%p", ev);
#if (NGX_HAVE_ACCEPT4)
        if (use_accept4) {
        ...
        *log = ls->log;
        ...
        ngx_log_error(NGX_LOG_ERR, c->log, 0, " ngx_event_accept Entry handler");
        ls->handler(c);
...
ngx_event_recvmsg(ngx_event_t *ev)
{
    ...
    do {
        ...
        *log = ls->log;
        ...
        ngx_log_error(NGX_LOG_ERR, c->log, 0, " ngx_event_recvmsg Entry handler");
        ls->handler(c);
